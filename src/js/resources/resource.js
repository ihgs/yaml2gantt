...
exports.tasks = function(
    _taskGroup, data, _rowHeight, _width,
    _xScale) { task.tasks(_taskGroup, data, _rowHeight, _width, _xScale); };
...
exports.sections = function(
    _sectionsGroup, data, _rowHeight,
    _width) { section.sections(_sectionsGroup, data, _rowHeight, _width); };
