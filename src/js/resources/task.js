...
exports.tasks = function(_tasksGroup, data, _rowHeight, _width, _xScale) {
  ...
  task_group
    ...
    .attr('y', function(item) {
      return item.y_index * _rowHeight + 20;
    })
  ...
  task_group
    ...
    .attr('y', function(item) {
      return item.y_index * _rowHeight + 30;
    })
    .text(function(item) {
      return item.name;
    });
  ...
  let events_text = task_group
    .selectAll('rect.events.text')
    .data(function(item) {
      return item.events;
    });
  events_text
    ...
    .attr('y', function(item) {
      return item.y_index * _rowHeight + 60;
    })
    .text(function(item) {
      return item.name;
    });
